...
import the7 from "../images/press/THE_SEVEN.jpeg";

export const links = [
  {
    name: "T Magazine",
    href: "https://www.nytimes.com/2023/01/18/t-magazine/andra-hem-bar-philadelphia.html",
    src: nyt,
  },
  {
    name: "Forbes",
    href: "https://www.forbes.com/sites/bethbernstein/2023/01/18/the-seven-west-village-an-enchanting-treasure-chest-of-independent-and-emerging-jewelry-designers/?sh=4a6b3a7a566e",
    src: the7,
  },
  {
